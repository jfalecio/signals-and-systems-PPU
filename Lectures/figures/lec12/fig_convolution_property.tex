\begin{tikzpicture}
	...
	\begin{groupplot}[
		...
		% --- PLOT 1: Rectangle Function ---
		\nextgroupplot[title={Signal $x_1(t)$}, ylabel={$x_1(t)$}]
		\addplot[blue, ultra thick] coordinates {
			(-2.5,0) (-0.5,0) (-0.5,1) (0.5,1) (0.5,0) (2.5,0)
		};
		\node[align=center,fill=white, inner sep=2pt] at (axis cs:2.2,0.9) {$x_1(t)=\text{rect}(t)$};
		
		% --- PLOT 2: Triangle Function ---
		\nextgroupplot[title={Signal $x_2(t)$}, ylabel={$x_2(t)$}]
		\addplot[red, ultra thick] coordinates {
			(-2.5,0) (-1,0) (0,1) (1,0) (2.5,0)
		};
		\node[align=center,fill=white, inner sep=2pt] at (axis cs:1.6,1) {$x_2(t)=\text{tri}(t)$};
		
		% --- PLOT 3: Convolution Exact Result ---
		\nextgroupplot[
		title={Convolution: $y(t)=x_1(t)*x_2(t)$},
	...
	\node[align=center] at (axis cs:2,0.9) {Piecewise quadratic\\shape};
		...
		\nextgroupplot[
		title={Spectra Product: $|Y(j\omega)| = |X_1(j\omega)X_2(j\omega)|$},
	...
	% Main Title
	\node[font=\large\bfseries, above=0.8cm] at
	($(convoplots c1r1.north)!0.5!(convoplots c2r1.north)$)
	{Illustration of the Convolution Theorem};
